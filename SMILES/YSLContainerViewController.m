...
- (void)viewDidLoad {
   ...
   _menuBackGroudColor=[UIColor colorWithRed:8.0/255.0 green:170.0/255.0 blue:87.0/255.0 alpha:1];
    [_menuView setBackgroundColor:self.menuBackGroudColor];
...
- (void)scrollMenuViewSelectedIndex:(NSInteger)index
{
    ...
    [_menuView setItemTextColor:self.menuItemTitleColor
           seletedItemTextColor:[UIColor whiteColor]currentIndex:index];
