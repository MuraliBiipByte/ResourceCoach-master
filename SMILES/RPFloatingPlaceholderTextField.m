...
- (void)setFloatingLabelActiveTextColor:(UIColor *)floatingLabelActiveTextColor
{
    ...
    NSString *controllerIdentifier=[defaultsforPlacehodercolor valueForKey:@"Controller"];
    
    _floatingLabelActiveTextColor = floatingLabelActiveTextColor;
    if (self.isEditing){
//        self.floatingLabel.textColor = floatingLabelActiveTextColor;
        if ([controllerIdentifier isEqualToString:@"LoginScreen"])
        {
        ...
        {
            self.floatingLabel.textColor =  [UIColor  colorWithRed:234.0/255.0 green:78.0/255.0 blue:80.0/255.0 alpha:1];
        }
    }
}
...
- (void)setupViewDefaults
{
    ...
    self.floatingLabel = [[UILabel alloc] init];
      self.floatingLabel.font = [UIFont boldSystemFontOfSize:12.f];
   // self.floatingLabel.font = [UIFont fontWithName:@"FuturaStd-Medium" size:12.0f];
    self.floatingLabel.textAlignment = self.textAlignment;
    self.floatingLabel.backgroundColor = [UIColor clearColor];
  
   // self.floatingLabel.textColor=[UIColor redColor];
...
- (void)setupDefaultColorStates
{
    ...
    self.floatingLabelActiveTextColor = self.floatingLabelActiveTextColor ?: [UIColor colorWithRed:234.0/255.0 green:78.0/255.0 blue:80.0/255.0 alpha:1];
    self.floatingLabelInactiveTextColor = self.floatingLabelInactiveTextColor ?: [UIColor lightGrayColor];
...
//        UIColor *placeholderGray = self.defaultPlaceholderColor ?: [UIColor colorWithRed:199/255.f green:199/255.f blue:205/255.f alpha:1.f];
        ...
        NSString *controllerIdentifier=[defaultsforPlacehodercolor valueForKey:@"Controller"];
        if ([controllerIdentifier isEqualToString:@"LoginScreen"]) {
           placeholderGray = self.defaultPlaceholderColor ?: [UIColor whiteColor];
            
        }
        else
        {
          placeholderGray = self.defaultPlaceholderColor ?: [UIColor darkGrayColor];
        }
...
//        _floatingLabel.textColor = strongSelf.floatingLabelActiveTextColor;
        ...
        if ([controllerIdentifier isEqualToString:@"LoginScreen"])
        {
            _floatingLabel.textColor = [UIColor  whiteColor];
            
        }
        else
        {
             _floatingLabel.textColor =  [UIColor  colorWithRed:234.0/255.0 green:78.0/255.0 blue:80.0/255.0 alpha:1];
        }
