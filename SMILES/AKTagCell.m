...
//        self.backgroundColor =[UIColor colorWithRed:32.0/255.0 green:178.0/255.0 blue:170.0/255.0 alpha:1];
...
-(UIButton *)deleteButton
{
	if (!_deleteButton){
		...
		[_deleteButton setBackgroundImage:[UIImage imageNamed:@"red.png"] forState:UIControlStateNormal];
		[_deleteButton setBackgroundImage:[UIImage imageNamed:@"gray.png"] forState:UIControlStateDisabled];
