...
- (void)setPlayer:(AVPlayer *)player
{
    @synchronized (self) {
        ...
        if (_player) {
            ...
            if (_timeObserver)
                (void)([_player removeTimeObserver:_timeObserver]), _timeObserver = nil;
...
- (void)didPlayButtonSelected:(id)sender
{
    if (_player.currentItem != nil)
    {
        ...
        {
            [_player pause];
            NSString *string=_currentTimeLabel.text;
            
            NSUserDefaults *def=[NSUserDefaults standardUserDefaults];
            [def setObject:string forKey:@"VCT"];
            
            
            NSLog(@"current time %@",string);
//            UIAlertController * alert=[UIAlertController alertControllerWithTitle:@"Video Current Time"
//                                                                          message:string
//                                                                   preferredStyle:UIAlertControllerStyleAlert];
//            UIAlertAction* okButton = [UIAlertAction actionWithTitle:@"Ok  thanks"
//                                                               style:UIAlertActionStyleDefault
//                                                             handler:^(UIAlertAction * action)
//                                       {
//                                           /** What we write here???????? **/
//                                           NSLog(@"you pressed ok, thanks button");
