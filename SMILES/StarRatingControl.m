...
@property (assign) NSUInteger numberOfStars;
@property (assign) NSUInteger currentIdx;
...
- (void)setupView {
	...
	_currentIdx = -1;
	_star = [UIImage imageNamed:@"star_empty.png"];
	_highlightedStar = [UIImage imageNamed:@"icon_star_fill.png"];
	...
	for (int i=0; i<_numberOfStars; i++) {
        ...
        //[v setBounds:CGRectMake(0, 0, 20, 20)];
		[self addSubview:v];
		[s addObject:v];
	}
	_stars = [s copy];
