...
//		[self addSubview:_statusLabel];
		...
		_arrowImage.frame = CGRectMake(frame.size.width/2, frame.size.height - 65.0f, 30.0f, 55.0f);
		_arrowImage.contentsGravity = kCAGravityResizeAspect;
		_arrowImage.contents = (id)[UIImage imageNamed:@"Refresh_icon.png"].CGImage;
        _arrowImage.contentsScale = [[UIScreen mainScreen] scale];
		[[self layer] addSublayer:_arrowImage];
		
        _activityView = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
		_activityView.frame = CGRectMake(frame.size.width/2, frame.size.height - 38.0f, 20.0f, 20.0f);
