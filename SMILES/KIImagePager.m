...
@synthesize slideshowTimer = _slideshowTimer;
...
{
//    _imageCounterBackground = [[UIView alloc] initWithFrame:CGRectMake(_scrollView.frame.size.width-(kOverlayWidth-4),    2,  kOverlayWidth,   kOverlayHeight)];
...
//    _countLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 30, 24)];
...
//     btnclose= [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 30, 24)];
//    [btnclose setBackgroundColor:[UIColor clearColor]];
//     btnclose.center = CGPointMake(15, _imageCounterBackground.frame.size.height/2);
//    [_imageCounterBackground addSubview:_countLabel];
//
