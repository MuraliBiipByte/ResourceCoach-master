...
- (void)dealloc
{
    ...
    (void) ([_overlayVC removeFromParentViewController]), _overlayVC = nil;
    (void)([_pipOverlayVC removeFromParentViewController]), _pipOverlayVC = nil;
    (void) ([self.player pause]), self.player = nil;
}
