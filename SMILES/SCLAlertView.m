...
- (void)setupViewWindowWidth:(CGFloat)windowWidth
{
    ...
    // Font
    _titleFontFamily = @"Roboto-Regular";
    _bodyTextFontFamily = @"Roboto-Regular";
    _buttonsFontFamily = @"Roboto-Regular";
    ...
    //[_viewText adjustsFontSizeToFitWidth];
    
    
    _viewText.font = [UIFont fontWithName:_bodyTextFontFamily size:_bodyFontSize];
   
   //    CGSize constraint = CGSizeMake(300, 1000.0f);
//    CGSize size_txt_overview1 = [_viewText.text sizeWithFont:[UIFont fontWithName:_bodyTextFontFamily size:_bodyFontSize] constrainedToSize:constraint lineBreakMode:UILineBreakModeWordWrap];
//    _viewText.frame = CGRectMake(20,20, size_txt_overview1.width, size_txt_overview1.height+15);
...
- (SCLAlertViewResponder *)showTitle:(UIViewController *)vc image:(UIImage *)image color:(UIColor *)color title:(NSString *)title subTitle:(NSString *)subTitle duration:(NSTimeInterval)duration completeText:(NSString *)completeText style:(SCLAlertViewStyle)style
{
    ...
    switch (style)
    {
        case SCLAlertViewStyleSuccess:
            viewColor = UIColorFromHEX(0x4170b6);
...
//            _viewText.l
//            _viewText.attributedText = [[NSAttributedString alloc] initWithString:subTitle attributes:attrsDictionary];
//          _viewText.textContainer.lineFragmentPadding = 0;
            
            [_viewText setText:subTitle];
    ...
    self.circleView.backgroundColor=[UIColor colorWithRed:41.0/255.0 green:54.0/255.0 blue:102.0/255.0 alpha:1];
    UIImageView*imageVi=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, self.circleView.frame.size.width, self.circleView.frame.size.height)];
    imageVi.image=[UIImage imageNamed:@"alertLogo"];
    [self.circleView addSubview:imageVi];
