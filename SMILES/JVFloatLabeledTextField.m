...
- (void)commonInit
{
   ...
   _floatingLabelTextColor = [UIColor colorWithRed:41.0/255.0 green:54.0/255.0 blue:102.0/255.0 alpha:1];
...
- (UIFont *)defaultFloatingLabelFont
{
    ...
    return [UIFont fontWithName:textFieldFont.fontName size:14.0f];
}
...
//                                self.labelActiveColor : self.floatingLabelTextColor);
    _floatingLabel.textColor=[UIColor colorWithRed:41.0/255.0 green:54.0/255.0 blue:102.0/255.0 alpha:1];
